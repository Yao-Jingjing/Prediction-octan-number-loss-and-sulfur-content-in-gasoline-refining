function [Best_score,Best_pos,cg_curve,BestNetSandXW]=DA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,Train_matrix,train_output,Test_matrix,test_datSet_output)
...
for iter=1:Max_iteration
    ...
    for i=1:SearchAgents_no %首先计算所有目标值
        [predict_all,Fitness(1,i),tmpnet]=fobj(Train_matrix,train_output,Test_matrix,test_datSet_output,X(:,i));
