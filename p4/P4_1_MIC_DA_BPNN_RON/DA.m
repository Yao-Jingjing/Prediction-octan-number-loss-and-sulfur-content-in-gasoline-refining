function [Best_score,Best_pos,cg_curve,BestNet]=DA(SearchAgents_no,Max_iteration,lb,ub,dim,fobj,Train_matrix,train_output,Test_matrix,test_datSet_output,PS_output)
...
for iter=1:Max_iteration
    ...
    for i=1:SearchAgents_no %首先计算所有目标值
        [Fitness(1,i),tmpNet]=fobj(Train_matrix,train_output,Test_matrix,test_datSet_output,PS_output,X(:,i));
